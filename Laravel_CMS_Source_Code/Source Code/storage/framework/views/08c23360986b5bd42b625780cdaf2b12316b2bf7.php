...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="listingLanguages"><i class="fa fa-dashboard"></i>Listing All Languages</a></li>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                    <?php echo Form::text('code',  '', array('class'=>'form-control field-validate', 'id'=>'code', 'maxlength'=>'2')); ?>
							...
							<div class="box-footer text-right">
                            	<div class="col-sm-offset-2 col-md-offset-3 col-sm-10 col-md-4">
                                    ...
                                    <a href="listingLanguages" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                                </div>
							</div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
